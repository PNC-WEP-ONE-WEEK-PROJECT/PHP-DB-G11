...
<div class="card w-100 post border-0 mt-3">
    <div class="card-header px-0 py-2 post-header border-0 w-100 d-flex justify-content-between">
        <div class="post-owner d-flex w-100">
            <a class="profile-contain d-flex" href="profile_view.php?seykey=<?php echo $user["user_ID"]; ?>"><img src="../images/<?php
            ...
            ?>"
                    alt=""></a>
            <div class="details">
                <a class="user-name" href="profile_view.php?seykey=<?php echo $user["user_ID"]; ?>"><?php echo $post["firstName"]  . " " . $post["lastName"] ?></a>
                <p class="m-0">
                    <?php  
                        $dates = $post["postDate"]; 
    ...
    <div class="card-footer px-0 w-100 py-0 mb-4 border-0 post-footer d-flex justify-content-between">
        ...
        <form action="<?php
            ...
            <button type="submit"><i onclick="increaseLike(<?php echo $index; ?>)" class="material-icons like like-icon"
                    id="<?php echo $index; ?>">thumb_up</i></button>
            ...
            <div class="content-comment mt-3 d-flex justify-content-end">
                ...
                ?> action="../controllers/delete_comment_controller.php" method="post"> 
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <button class="dropdown-item" type="submit"><i class="material-icons text-danger">delete_forever</i></button>
                        <a class="dropdown-item" href="edit_comment_view.php?comment_ID=<?php echo $comment['comment_ID'] ?>"> <i class="text-primary material-icons">edit</i></a>
                    </div>
                </form> 
            </div>
