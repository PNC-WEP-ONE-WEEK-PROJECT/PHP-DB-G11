...
<nav id="navigation" class="navbar py-0 bg-light">
    ...
    <ul class="nav nav-pills d-flex justify-content-between" id="nav-menu">
        <li class="nav-item">
            <a class="nav-link" href="../controllers/refresh_page.php"><i class="material-icons menu-icon">home</i></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href=""><i class="material-icons menu-icon">people</i></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href=""><i class="material-icons menu-icon">account_circle</i></a>
        </li>
    </ul>
</nav>